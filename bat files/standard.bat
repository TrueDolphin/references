...
set duration=14400
set modlist="-mod=WS/@Fallujah;WS/@Community-Online-Tools;WS/@CF;WS/@Dabs Framework;WS/@DayZ-Expansion-AI;WS/@DayZ-Expansion-Core;WS/@DayZ-Expansion-Animations;"
set servermods="-servermod="
set startargs=-config=%serverConfig% -profiles=Profiles -port=%serverPort% -cpuCount=%serverCPU% -server -adminlog -netlog -startNavmeshDataServer -freezecheck
